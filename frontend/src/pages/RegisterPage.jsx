    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-n-8 relative overflow-hidden pt-20 pb-20">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="h2 mb-2 text-n-1">Create Account</h1>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-n-4">At least 6 characters</p>
            </div>
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-n-8 text-n-4">
        ...
        {/* Footer Text */}
        <p className="text-center text-n-4 caption mt-8 px-4">
